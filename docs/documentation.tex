...
Backend można także uruchomić z terminala:
...
Po uruchomieniu API udostępnia Swagger UI pod adresem bazowym aplikacji, ponieważ endpoint \texttt{/} przekierowuje do \texttt{/swagger}. Dostępny jest również prosty endpoint kontrolny:
